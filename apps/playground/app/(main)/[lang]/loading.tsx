	...
	return (
		<main className="relative overflow-x-hidden bg-background">
			<section className="relative z-10 mx-auto flex min-h-[70vh] max-w-6xl flex-col justify-center px-4 py-20">
				...
				<div className="mb-4 h-10 w-3/4 animate-pulse rounded bg-muted md:h-12" />
				...
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
					{Array.from({ length: 6 }).map((_, i) => (
						...
						>
							...
							<div className="mb-2 h-4 w-2/3 animate-pulse rounded bg-muted" />
							<div className="h-3 w-full animate-pulse rounded bg-muted" style={{ animationDelay: `${i * 80}ms` }} />
