      ...
      <div className="flex flex-col md:items-end gap-2 shrink-0">
        {!hideNavigation && (
          <Button 
            ...
            className="h-8 px-2 text-xs border border-border/50"
          >
        ...
        {isCompleted && (
          <div className={cn(
            "flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider transition-all animate-in zoom-in-50 duration-300 shadow-sm",
                ...
                <div className="flex justify-between items-center mb-4 gap-2">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <Button 
                      ...
                      className="h-7 px-2 text-[10px] border border-border/50"
                    >
                      <Languages className="mr-1 h-3 w-3" />
                      {lang === "sw" ? "EN" : "SW"}
                    </Button>
                    {isCompleted && (
                      <div className="bg-green-500/10 text-green-500 p-1 rounded-full border border-green-500/20 shadow-sm animate-in zoom-in-50">
                        <CheckCircle2 className="h-3 w-3" />
                      </div>
                    )}
                  </div>
